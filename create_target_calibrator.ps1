# create target calibrator artifact from observed calibration parameters
New-Item -ItemType Directory -Path ho_artifact_outputs -Force | Out-Null
$py = @"
import pickle
...
print("WRITTEN", p)
"@
$py | Set-Content save_target_calibrator.py -Force
python save_target_calibrator.py
